...
function initTowhub() {
    ...
    $('.close-2 , .reg-overlay_2').on("click", function () {
        modal.hide2();
    });
    $('.close-3 , .reg-overlay_3').on("click", function () {
        modal.hide3();
    });
    ...
    $(".custome-user-name").on("click", function () {
        $(".custome-user-search ul").toggleClass("hu-menu-vis");
        $(this).toggleClass("hu-menu-visdec");
    });
    // Counter ------------------
...
function ModalOpen2() {
    $('.modal_3 , .reg-overlay_3').fadeIn(200);
    $(".modal_main_3").addClass("vis_mr");
    $("html, body").addClass("hid-body");
}