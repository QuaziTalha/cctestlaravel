    ...
    195: function (t, e, n) {
        ...
        var h = {
            ...
            _unbindLayoutAnimationEndEvent: function () {
                var t = this,
                    e = this.getMenu();
                this._transitionCallbackTimeout && (clearTimeout(this._transitionCallbackTimeout), this._transitionCallbackTimeout = null), e && this._transitionCallback && l.forEach((function (n) {
            ...
            _bindMenuMouseEvents: function () {
                ...
                if (!(this._menuMouseEnter && this._menuMouseLeave && this._windowTouchStart)) {
                    ...
                    }, e.addEventListener("mouseenter", this._menuMouseEnter, !1), e.addEventListener("touchstart", this._menuMouseEnter, !1)), this._menuMouseLeave || (this._menuMouseLeave = function () {
                        t._setMenuHoverState(!1)
                    }, e.addEventListener("mouseleave", this._menuMouseLeave, !1)), this._windowTouchStart || (this._windowTouchStart = function (e) {
            ...
            setPosition: function () {
                ...
                this._removeClass("layout-menu-offcanvas layout-menu-fixed layout-menu-fixed-offcanvas"), !t && e ? this._addClass("layout-menu-offcanvas") : t && !e ? (this._addClass("layout-menu-fixed"), this._redrawLayoutMenu()) : t && e && (this._addClass("layout-menu-fixed-offcanvas"), this._redrawLayoutMenu()), this.update()
            },
            ...
            on: function () {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : f("event"),
                    ...
                    u = i(a),
                    l = u.slice(1);
                l = l.join(".") || null, this._listeners.push({
                    event: s,
                    namespace: l,
                    callback: e
                })
            ...
            off: function () {
                var t = this,
                    ...
                    u = i(a),
                    l = u.slice(1);
                l = l.join(".") || null, this._listeners.filter((function (t) {
            ...
            init: function () {
                ...
                this._initialized || (this._initialized = !0, this._updateInlineStyle(0), this._bindWindowResizeEvent(), this.off("init._Helpers"), this.on("init._Helpers", (function () {
                    t.off("resize._Helpers:redrawMenu"), t.on("resize._Helpers:redrawMenu", (function () {
            ...
            initCustomOptionCheck: function () {
                ...
                [].slice.call(document.querySelectorAll(".custom-option .form-check-input")).map((function (e) {
                    t.updateCustomOptionCheck(e), e.addEventListener("click", (function (n) {
                ...
                if (null != t && null != e) {
                    ...
                    document.querySelectorAll(".speech-to-text i").forEach((function (t) {
                        ...
                        t.addEventListener("click", (function () {
                            t.closest(".input-group").querySelector(".form-control").focus(), n.onspeechstart = function () {
                                e = !0
                ...
                document.querySelectorAll('[data-bs-toggle="sidebar"]').forEach((function (t) {
                    t.addEventListener("click", (function () {
                        ...
                        document.querySelectorAll(e).forEach((function (t) {
                            t.classList.toggle("show"), null != n && !1 !== n && void 0 !== i && (t.classList.contains("show") ? i[0].classList.add("show") : i[0].classList.remove("show"), i[0].addEventListener("click", (function (e) {
