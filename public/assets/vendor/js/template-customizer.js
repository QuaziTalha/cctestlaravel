! function (t, e) {
            ...
            b = function () {
                function t(e) {
                    ...
                    if (function (t, e) {
                        ...
                        if (this.settings = {}, this.settings.cssPath = s, this.settings.themesPath = i, this.settings.cssFilenamePattern = a || "%name%.css", this.settings.displayCustomizer = void 0 === o || o, this.settings.controls = n || l, this.settings.defaultTextDir = "rtl" === c || h, this.settings.defaultLayoutType = b || g, this.settings.defaultMenuCollapsed = void 0 !== v ? v : m, this.settings.defaultMenuFlipped = void 0 !== _ ? _ : p, this.settings.defaultShowDropdownOnHover = void 0 !== w ? w : void 0, this.settings.defaultNavbarFixed = void 0 !== x ? x : y, this.settings.defaultFooterFixed = void 0 !== S ? S : f, this.settings.availableThemes = F || t.THEMES, this.settings.defaultTheme = this._getDefaultTheme(void 0 !== C ? C : u), this.settings.styles = z || r, this.settings.defaultStyle = k || d, this.settings.lang = E || "en", this.pathResolver = A || function (t) {
                                return t
                ...
                return e = t, (s = [{
                    ...
                    value: function (t) {
                        ...
                        if (this._hasControls("themes")) {
                            ...
                            if (i) {
                                ...
                                this._loadStylesheets(o({}, a, document.querySelector(".template-customizer-theme-css")), s || function () {}), e && this.settings.onSettingsChange.call(this, this.settings)
                            }
                        }
                    }
                }, {
                    ...
                    value: function () {
                        ...
                        if (this._hasControls("style")) {
                            ...
                            h.addEventListener("change", m), this._listeners.push([h, "change", m])
                        } else d.parentNode.removeChild(d);
                        var p = this.container.querySelector(".template-customizer-themes");
                        if (this._hasControls("themes")) {
                            var y = p.querySelector(".template-customizer-themes-options");
                        ...
                        if (this._hasControls("layoutType layoutNavbarFixed layoutFooterFixed layoutMenuFlipped showDropdownOnHover", !0)) {
                            ...
                            if (this._hasControls("layoutType")) {
                                ...
                                this._controls.layoutType.addEventListener("change", v), this._listeners.push([this._controls.layoutType, "change", v])
                    ...
                    value: function (t) {
                        ...
                        if (document.querySelector('[data-template="horizontal-menu-template"]') && 1 === t && (t = 0), !(e = "string" == typeof t ? this._getThemeByName(t, !1) : this.settings.availableThemes[t])) throw new Error('Theme ID "'.concat(t, '" not found!'));
                        return e
                    }
                }, {
                    key: "_getThemeByName",
                ...
                }]) && n(e.prototype, s), i && n(e, i), Object.defineProperty(e, "prototype", {
                    writable: !1
                }), t
            }();
        b.THEMES = [{
    ...
    6: function (t, e, s) {
        ...
        function h(t, e, s, i) {
            var a = s ? "" : i.media ? "@media ".concat(i.media, " {").concat(i.css, "}") : i.css;
        ...
        function f(t, e) {
            ...
            if (e.singleton) {
                var o = y++;
                s = p || (p = c(e)), i = h.bind(null, s, o, !1), a = h.bind(null, s, o, !0)
            } else s = c(e), i = m.bind(null, s, e), a = function () {
                ! function (t) {
        ...
        t.exports = function (t) {
            ...
            return e.toString = function () {
                return this.map((function (e) {
                    var s = function (t, e) {
                        ...
                        if (e && "function" == typeof btoa) {
                            var a = (n = i, l = btoa(unescape(encodeURIComponent(JSON.stringify(n)))), r = "sourceMappingURL=data:application/json;charset=utf-8;base64,".concat(l), "/*# ".concat(r, " */")),
                ...
                for (var l = 0; l < t.length; l++) {
                    var r = [].concat(t[l]);
                    i && a[r[0]] || (s && (r[2] ? r[2] = "".concat(s, " and ").concat(r[2]) : r[2] = s), e.push(r))
                }
            }, e
        }
    }
