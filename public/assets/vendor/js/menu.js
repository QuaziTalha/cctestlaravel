                ...
                return t = e, o = [{
                    ...
                    value: function (t, n, i) {
                        ...
                        if (t) {
                            ...
                            s ? u + this._innerPosition + 2 * c > l && c < l && c >= d && (o.style.left = [this._rtl ? "100%" : "-100%"]) : u + this._innerPosition + c > l && c < l && c > d && (o.style[this._rtl ? "marginRight" : "marginLeft"] = "-".concat(c - d, "px")), this._closeOther(r, i), this._updateSlider()
                        } else {
                            ...
                            if (i[r].classList.add("open"), this._accordion)
                                for (var l = e._findChild(i[r].parentNode, ["menu-item", "open"]), a = 0, u = l.length; a < u; a++)
                                    if (l[a] !== i[r] && (l[a].classList.remove("open"), n))
                                        for (var d = l[a].querySelectorAll(".menu-item.open"), c = 0, h = d.length; c < h; c++) d[c].classList.remove("open");
                        return o
                    }
                }, {
                    ...
                    value: function (e) {
                        ...
                        if ("vertical" === e) {
                            ...
                            for (var p = 0; p < d.length; ++p) d[p].classList.remove("open")
                        }
                        this._bindEvents()
                    }
                }, {
